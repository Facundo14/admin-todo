...
export const metadata = {
    ...
    description: 'Productos en carrito de compras',
};
                ...
                <div className="flex flex-col w-full sm:w-4/12">
                    <WidgetItem title='Total a pagar'>
                        <div className='mt-2 flex justify-center gap-4'>
                            <h3 className='text-3xl font-bold text-grey-700'>${ (totalToPay * 1.25 ).toFixed(2)}</h3>
                        </div>
                        <span className='font-bold text-center text-gray-500'>Impuestos 25%: ${ totalToPay * 0.25 }</span>
                    </WidgetItem>
                </div>
